...
\begin{figure}
  ...
  \begin{tikzpicture}
    [ level distance=0.75cm, sibling distance=0.5cm,
      subtree/.style = {isosceles triangle, shape border rotate=90, anchor=north, yshift=1mm, inner sep=0cm}
    ]
    \node(before) {
      \Tree [.\node[color=red]{A}; 
...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \node(first) {
      \Tree [.\node[color=blue]{A};
        [.\node[color=green!80!black]{B}; 
          [.\node[subtree, minimum height=1cm]{C}; ] 
          [.\node[color=red]{D};
            [.\node[subtree, minimum height=1cm]{E}; ] 
            [.\node[subtree, minimum height=1cm]{F}; ] ] ] 
        [.\node[subtree, minimum height=1cm]{G}; ] ]
    };
    ...
    \node(third) [at={($(second.south west) + (-0.5cm,-1cm)$)}, anchor=north] {
      \Tree [.\node[color=red]{D};
        [.\node[color=green!80!black, yshift=-2mm]{B};
          [.\node[subtree, minimum height=1cm, yshift=-5mm]{C}; ] 
          [.\node[subtree, minimum height=1cm, yshift=-5mm]{E}; ] ] 
        [.\node[color=blue, yshift=-2mm]{A};
          [.\node[subtree, minimum height=1cm, yshift=-5mm]{F}; ] 
          [.\node[subtree, minimum height=1cm, yshift=-5mm]{G}; ] ] ]
    };
