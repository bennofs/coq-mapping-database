...
\newcommand{\ttcomment}[1]{{\bfseries\color{red}TT: #1}}
\newcommand{\ttreplace}[2]{{\bfseries\color{red}TT: #1} {\bfseries\color{blue}BF: #2}}
\newcommand{\note}[1]{{\bfseries\color{green}N: #1}}

% meine Kommentare abschalten
%\renewcommand{\ttcomment}[1]{}
%\renewcommand{\ttreplace}[2]{#2}
